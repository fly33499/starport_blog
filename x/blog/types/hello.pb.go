...
func (*Hello) Descriptor() ([]byte, []int) {
	return fileDescriptor_91c6e45b29427e66, []int{0}
}
...
func (m *Hello) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Hello)(nil), "alice.blog.blog.Hello")
}

func init() { proto.RegisterFile("blog/hello.proto", fileDescriptor_91c6e45b29427e66) }

var fileDescriptor_91c6e45b29427e66 = []byte{
	// 196 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x48, 0xca, 0xc9, 0x4f,
	0xd7, 0xcf, 0x48, 0xcd, 0xc9, 0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4f, 0xcc,
	0xc9, 0x4c, 0x4e, 0xd5, 0x03, 0x89, 0x83, 0x09, 0x29, 0x91, 0xf4, 0xfc, 0xf4, 0x7c, 0xb0, 0x9c,
	0x3e, 0x88, 0x05, 0x51, 0xa6, 0x14, 0xcd, 0xc5, 0xea, 0x01, 0xd2, 0x25, 0x24, 0xc1, 0xc5, 0x9e,
	...
	0x89, 0x70, 0xb1, 0x96, 0x64, 0x96, 0xe4, 0xa4, 0x4a, 0x30, 0x83, 0xd5, 0x41, 0x38, 0x42, 0x42,
	0x5c, 0x2c, 0x49, 0xf9, 0x29, 0x95, 0x12, 0x2c, 0x60, 0x41, 0x30, 0xdb, 0xc9, 0xe6, 0xc4, 0x23,
	...
	0x92, 0xf3, 0x73, 0xf5, 0xc1, 0x0e, 0xd5, 0x07, 0x7b, 0xa0, 0x02, 0x42, 0x95, 0x54, 0x16, 0xa4,
	0x16, 0x27, 0xb1, 0x81, 0x5d, 0x68, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x80, 0x7f, 0xec, 0x39,
	0xdc, 0x00, 0x00, 0x00,
}
...
func (m *Hello) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintHello(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintHello(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
