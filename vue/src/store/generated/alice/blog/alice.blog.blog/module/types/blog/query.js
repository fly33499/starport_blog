...
const baseQueryGetHelloRequest = { id: 0 };
export const QueryGetHelloRequest = {
    ...
    decode(input, length) {
        ...
        const message = { ...baseQueryGetHelloRequest };
...
const baseQueryGetHelloResponse = {};
export const QueryGetHelloResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetHelloResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllHelloRequest = {};
export const QueryAllHelloRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllHelloRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllHelloResponse = {};
export const QueryAllHelloResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllHelloResponse };
        message.Hello = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Hello(request) {
        ...
        return promise.then((data) => QueryGetHelloResponse.decode(new Reader(data)));
    }
    HelloAll(request) {
        const data = QueryAllHelloRequest.encode(request).finish();
        const promise = this.rpc.request("alice.blog.blog.Query", "HelloAll", data);
        return promise.then((data) => QueryAllHelloResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
