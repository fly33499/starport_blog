...
const baseGenesisState: object = { helloCount: 0 };
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.helloCount = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.helloList) {
      obj.helloList = message.helloList.map((e) =>
        e ? Hello.toJSON(e) : undefined
      );
    } else {
      obj.helloList = [];
    }
